...
public class PanneauInitialisation extends DialogPane {
    ...
    public Initialisation getInitialisation(ButtonBar.ButtonData choix) {
        return choix == ButtonBar.ButtonData.OK_DONE ? PANNEAU_INIT.getAfterValidation() : PANNEAU_INIT.getAfterCancelation();
    }

    void setInitialisation(Initialisation initialisation) {
        PANNEAU_INIT.setInitialisation(initialisation);
    }
}
