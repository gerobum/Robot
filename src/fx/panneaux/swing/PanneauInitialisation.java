...
public class PanneauInitialisation extends javax.swing.JPanel {
    ...
    public PanneauInitialisation(Initialisation initialisation) {
        ...
        comboOrientationRobot.setSelectedIndex(initialisation.getOrientationRobot().ordinal()+1);
        comboPositionMinerai.setSelectedIndex(initialisation.getPositionMinerai().ordinal()+1);
        comboPositionRobot.setSelectedIndex(initialisation.getPositionRobot().ordinal()+1);
